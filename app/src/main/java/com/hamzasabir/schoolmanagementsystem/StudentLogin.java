...
public class StudentLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter.addFragment(new StuLoginFragment(),"Log In"); //create seperate Fragment in project
        viewPagerAdapter.addFragment(new StuSignUpFragment(),"Sign Up"); //create seperate Fragment in project
